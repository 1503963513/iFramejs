...
## 参与贡献与反馈 (Feedback & Contributing)

`iframe-js` 的初衷是为了彻底消灭前端业务中那些恶心人的 iframe 跨域通信痛点。虽然目前它已经具备了诸如 RPC、状态同步、自动高度等强大特性，但真实的业务场景永远是千变万化的。

**我们非常期待听到你的声音！**

- **发现了 Bug** 跨域环境诡谲多变，如果你遇到了报错或行为不符合预期，请毫不犹豫地提交 Issue！最好能附上报错截图或简单的复现步骤，我们会第一时间排查修复。
- **有想要的新功能？** 你还在用什么“野生”的技巧处理 iframe？还有哪些高频的业务场景（比如拖拽穿透、跨域 Cookie 同步等）希望被封装进来？非常欢迎在 Issue 里提出你的 `Feature Request`，我们可以一起探讨最佳的架构方案！
- **愿意提交代码 (PR)？** 极度欢迎！无论是一处文档的错别字修正，还是一个核心逻辑的性能优化，都非常感谢你对开源的贡献。

**[点击这里提交 Issue 或 需求建议](https://github.com/1503963513/iFramejs/issues)**

---

## ⭐️ 支持一下 (Support)

如果你觉得 `iframe-js` 确实帮到了你，或者为你的项目节省了宝贵的开发和掉头发的时间，欢迎给这个项目点一个免费的 **Star ⭐️**！

你的每一个 Star 都是推动这个项目不断迭代完善的最强动力！❤️
